...
echo start %gameDirectory%DayZ_x64.exe %clientLaunchParams% "-mod=%modList%" "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true"

start %gameDirectory%DayZ_x64.exe %clientLaunchParams% "-mod=%modList%" "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true" -connect=127.0.0.1:2302
